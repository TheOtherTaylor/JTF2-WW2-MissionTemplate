...
player addWeapon "LIB_Laffete_Tripod";
...
for "_i" from 1 to 2 do {player addItemToVest "LIB_100Rnd_792x57";};
for "_i" from 1 to 3 do {player addItemToBackpack "LIB_100Rnd_792x57";};
